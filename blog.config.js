...
const BLOG = {
  ...
  GREETING_WORDS:
    ...
    'Hi，我是dengweixin，这是关于Syntr和我的博客。',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Syntr', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '优衣库爱好者', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://space.bilibili.com/81208802', // 网站地址
  ...
  CONTACT_BILIBILI: process.env.NEXT_PUBLIC_CONTACT_BILIBILI || 'https://space.bilibili.com/81208802', // B站主页
  CONTACT_YOUTUBE: process.env.NEXT_PUBLIC_CONTACT_YOUTUBE || '', // Youtube主页
  CONTACT_XIAOHONGSHU: process.env.NEXT_PUBLIC_CONTACT_XIAOHONGSHU || 'https://www.xiaohongshu.com/user/profile/56ad865350c4b43f7c2a268a', // 小红书主页
